...
\resumeSubHeadingListStart
\item{Stochastic algorithms, sketching methods, algorithmic bias, reinforcement learning}
\resumeSubHeadingListEnd
...
\resumeSubHeadingListStart
\item{Difan Zou*, \textbf{Jingfeng Wu}*, Vladimir Braverman, Quanquan Gu and Sham M. Kakade. ``Benign Overfitting of Constant-Stepsize SGD for Linear Regression.'' 	Annual Conference on Learning Theory (COLT), 2021.}
